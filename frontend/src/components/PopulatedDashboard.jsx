        ...
        <div className="p-10 pt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {setsToDisplay.map((set, index) => (
              <div 
                key={index} 
                onClick={() => navigate('/study')} // Defaults to Map view
              ...
              >
                ...
                <div className="flex justify-around mt-4 pt-2">
                  ...
                  {/* QUICK QUIZ BUTTON - Passes State to Start Quiz Immediately */}
                  <div 
                    onClick={(e) => {
                      e.stopPropagation(); // Stops the card click
                      navigate('/study', { state: { startInQuizMode: true } }); 
                    }}
                    className="flex flex-col items-center gap-2 group cursor-pointer bg-transparent"
                  >
                  ...
                  {/* VIEW MAP BUTTON - Normal Navigation */}
                  <div 
                    onClick={(e) => {
                      e.stopPropagation(); // Stops the card click
                      navigate('/study'); 
      ...
      <div className="w-[340px] bg-[#0B1120] border-l border-gray-800/50 flex flex-col z-20 shadow-2xl shrink-0">
        <div className="p-8 pb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center text-sm font-bold text-gray-800">A</div>
          </div>
        </div>
