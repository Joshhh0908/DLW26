...
const StudyDashboard = () => {
  ...
  return (
    <div className="h-screen w-screen bg-[#060B14] font-sans text-white overflow-hidden relative selection:bg-blue-500/30">
      ...
      {/* --- MAIN GRAPH AREA --- */}
      <div className="absolute top-0 right-0 bottom-0 left-64 overflow-hidden z-10 flex items-center justify-center">
        ...
        {/* Show a loading spinner while fetching from Python */}
        {isLoading ? (
